...
const complexScrapeSpecifications = {
  ...
  cm3et6qjj00018upjdxokxq0m: {
    getComplexApartments: getApartmentsRitchStreet,
    getComplexParams: getParamsRitchStreet
  }
};
...
async function fetchDataWithRetry(id, url, params, retries = 2, backoff = 300) {
  try {
