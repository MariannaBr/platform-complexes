  ...
  const params = {
    ...
    extract_rules: {
      apartments: {
        ...
        output: {
          beds: {
            selector: ".jd-fp-floorplan-card__info-details > span:nth-child(1)",
          },
          baths: {
            selector: ".jd-fp-floorplan-card__info-details > span:nth-child(2)",
          },
          area: {
            selector: ".jd-fp-floorplan-card__info-details > span:nth-child(3)",
          },
          price: {
