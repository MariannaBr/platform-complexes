    ...
    messages: [
      {
        ...
        content:
          ...
          "You are an expert in analyzing data from html code and you will get a html code that collects data about a unit. Your task is to extract the data about the unit from the html code. Create a json with the unit's title, number of bedrooms, number of bathrooms, square feet, price, link of unit's picture and link for applying for the unit if it's given. The keys are named as: title, bedrooms, bathrooms, area, price, image_link, apartment_link",
      },
      {
        role: "user",
        content: input,
